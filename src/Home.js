...
import { fetchAsyncMovies ,fetchAsyncTV,fetchAsyncSearch,fetchAsyncPRIMEVIDEOS, fetchAsyncPRIMEVIDEOSm} from "./features/movie/movieSlice";
...
// }
 ...
 dispatch(setsearchData(response.data))
  ...
  useEffect(() => {
    ...
    dispatch(fetchAsyncPRIMEVIDEOS());
    dispatch(fetchAsyncPRIMEVIDEOSm());
    // fetchsearch();
